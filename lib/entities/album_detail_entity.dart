...
AlbumDetailEntity albumDetailEntityFromJson(String str) => AlbumDetailEntity.fromJson(json.decode(str));
String albumDetailEntityToJson(AlbumDetailEntity data) => json.encode(data.toJson());
class AlbumDetailEntity {
  ...
  AlbumDetailEntity.fromJson(dynamic json) {
    _id = json['id'];
  ...
  dynamic _price;
  int? _min;
AlbumDetailEntity copyWith({  int? id,
  String? seriesName,
  String? createTime,
  String? updateTime,
  String? cover,
